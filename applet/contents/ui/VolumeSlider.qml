...
PC3.Slider {
    ...
    background: PlasmaCore.FrameSvgItem {
        ...
        PlasmaCore.FrameSvgItem {
            ...
            anchors.left: parent.left
            anchors.bottom: parent.bottom
            width: control.horizontal ? Math.max(fixedMargins.left + fixedMargins.right, meter.volume * control.position * control.availableWidth) : parent.width
            height: control.vertical ? Math.max(fixedMargins.top + fixedMargins.bottom, meter.volume * control.position * control.availableHeight) : parent.height
