        ...
        footer: PlasmaExtras.PlasmoidHeading {
            ...
            ColumnLayout {
                ...
                Kirigami.InlineMessage {
                    ...
                    text: xi18nc("@info", "This feature is for temporarily boosting very quiet sounds; using it to louden normal-volume sounds will damage your hearing and the device's speakers.<nl/><nl/>It will be automatically turned off when the system restarts or goes to sleep.")
                }
