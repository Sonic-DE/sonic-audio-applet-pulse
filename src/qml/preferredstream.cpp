...
PreferredStream::PreferredStream(QObject *parent)
    : QObject(parent)
{
    connect(PulseAudioQt::Context::instance(), &PulseAudioQt::Context::sinkAdded, this, [this](PulseAudioQt::Sink *sink) {
        connect(sink, &PulseAudioQt::Sink::stateChanged, this, &PreferredStream::updatePreferredSink, Qt::UniqueConnection);
        updatePreferredSink();
    });
    connect(PulseAudioQt::Context::instance(), &PulseAudioQt::Context::sinkRemoved, this, &PreferredStream::updatePreferredSink);
    connect(PulseAudioQt::Context::instance()->server(), &PulseAudioQt::Server::defaultSinkChanged, this, &PreferredStream::updatePreferredSink);
}

PulseAudioQt::Sink *PreferredStream::sink()
{
    return m_sink;
}

void PreferredStream::updatePreferredSink()
{
...
[[nodiscard]] PulseAudioQt::Sink *PreferredStream::findPreferredSink() const
{
